...
<?php if ($place == "topMenu") : ?>
    <?php if ($logo->hasImage()) : ?>
        <a class="navbar-brand hidden-xs" style="height: 50px; padding:5px;"
           href="<?php echo Yii::$app->homeUrl; ?>" onclick="removeActivitiesDiv()">
            <img class="img-rounded" src="<?php echo $logo->getUrl(); ?>"
                 id="img-logo"/>
        </a>
    <?php endif; ?>
    <a class="navbar-brand" style="<?php if ($logo->hasImage()) : ?>display:none;<?php endif; ?> "
       href="<?php echo Yii::$app->homeUrl; ?>" id="text-logo" onclick="removeActivitiesDiv()">
...
<?php if ($place == "login") : ?>
    <?php if ($logo->hasImage()) : ?>
        <a href="<?php echo Yii::$app->homeUrl; ?>" onclick="removeActivitiesDiv()">
            <img class="img-rounded" src="<?php echo $logo->getUrl(); ?>"
                 id="img-logo"/>
        </a>
        <br>
